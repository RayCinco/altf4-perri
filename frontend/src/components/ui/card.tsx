...
function CardTitle({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn("font-heading text-base leading-snug font-medium text-white", className)}
      {...props}
    />
  )
}
...
function CardFooter({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "flex items-center rounded-b-xl border-t border-[#001D3F] bg-[#0a1a3a] p-4 group-data-[size=sm]/card:p-3",
        className
      )}
      {...props}
    />
